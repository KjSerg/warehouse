        ...
        if (svg) {
          ...
          if (paths) {
            label.querySelector('input').addEventListener('focus', function () {
              var timeline = gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.timeline({
                repeat: -1,
                repeatDelay: 0.1,
                defaults: {
                  ease: 'power1.inOut'
            ...
            label.querySelector('input').addEventListener('blur', function () {
              gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.globalTimeline.clear();
              gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.killTweensOf(paths);
