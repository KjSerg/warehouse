...
/* harmony import */ var _number_input__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_number-input */ "./resources/js/components/_number-input.js");
...
/* harmony import */ var _accardion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_accardion */ "./resources/js/components/_accardion.js");
/* harmony import */ var _GoogleMap__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./GoogleMap */ "./resources/js/components/GoogleMap.js");
/* harmony import */ var _fancybox_init__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fancybox-init */ "./resources/js/components/fancybox-init.js");
/* harmony import */ var _Slick__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Slick */ "./resources/js/components/Slick.js");
...
var Application = /*#__PURE__*/function () {
  ...
  return _createClass(Application, [{
    ...
    value: function initSvgAnimation() {
      var t = this;
      console.log(t);
      document.querySelectorAll('.form-label').forEach(function (label) {
        ...
        if (svg) {
          ...
          if (paths) {
            ...
            label.querySelector('input').addEventListener('blur', function () {
              gsap__WEBPACK_IMPORTED_MODULE_7__.gsap.globalTimeline.clear();
              gsap__WEBPACK_IMPORTED_MODULE_7__.gsap.killTweensOf(paths);
  ...
  return _createClass(GoogleMap, [{
    ...
    value: function loadGoogleMapsScript() {
      return new Promise(function (resolve, reject) {
        ...
        script.src = "https://maps.googleapis.com/maps/api/js?key=".concat(googleMapApiKey);
        script.async = true;
        script.defer = true;
    ...
    value: function initializeMaps() {
      var _this2 = this;
      document.querySelectorAll('.google-map').forEach(function (mapElement) {
        _this2.renderMapItem(mapElement);
      });
    }
  }, {
    key: "renderMapItem",
    value: function renderMapItem(mapElement) {
      var lat = parseFloat(mapElement.getAttribute('data-lat'));
      var lng = parseFloat(mapElement.getAttribute('data-lng'));
      var zoom = parseInt(mapElement.getAttribute('data-zoom')) || 10;
      var markerIcon = mapElement.getAttribute('data-src');
...
var Slick = /*#__PURE__*/function () {
  ...
  return _createClass(Slick, [{
    key: "aboutSliderInit",
    value: function aboutSliderInit() {
...
/***/ "./resources/js/components/_accardion.js":
/*!***********************************************!*\
  !*** ./resources/js/components/_accardion.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/_number-input.js":
/*!**************************************************!*\
  !*** ./resources/js/components/_number-input.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var numberInput = function numberInput() {
  ...
  $(document).on('click', '.number-input-button', function (e) {
    e.preventDefault();
    var $t = $(this);
    var isPlus = $t.hasClass('plus');
    var $input = $t.closest('.form-label-container').find('input');
    var step = $input.attr('data-step') || $input.attr('step') || 0.1;
    var min = $input.attr('data-min') || $input.attr('min');
    var max = $input.attr('data-max') || $input.attr('max');
...
/***/ "./resources/js/components/fancybox-init.js":
/*!**************************************************!*\
  !*** ./resources/js/components/fancybox-init.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
